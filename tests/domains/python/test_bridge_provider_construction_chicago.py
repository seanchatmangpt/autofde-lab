...
def _run_construction_checks(
    script_text: str, cases: list[tuple[str, str, str]]
) -> dict:
...
_VENDOR_CASE = [
    ("gymact.gyms.vendor_benchmarks", "VendorBenchmarkProvider", "agentdojo")
]


@pytest.mark.parametrize(
    "script_text", [_BRIDGE_SCRIPT, _EXECUTE_SCRIPT], ids=["discovery", "actuation"]
)
