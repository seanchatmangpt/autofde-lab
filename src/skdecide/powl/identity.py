...
:func:`skdecide.fabric.canonical.canonical_json` + ``sha256``. Two invariants
are load-bearing:
...
from skdecide.fabric.canonical import sha256 as _sha256
...
def activity_sha256(atom: Atom) -> str:
    """Content hash of an :class:`~skdecide.powl.algebra.Atom`.
