...
is a :data:`~skdecide.powl.refusals.PowlRefusal.DANGLING_REFERENCE`.
...
:data:`~skdecide.powl.refusals.PowlRefusal.EDGE_TYPE_MISMATCH`.
...
from skdecide.powl.frequency import ONCE, Frequency
...
class ChoiceGraphEdge:
    ...
    Distinct from :class:`OrderEdge` — see the module docstring.
    """
