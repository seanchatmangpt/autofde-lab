...
---------------------
**This module must never import** :mod:`skdecide.powl.executor` or
:mod:`skdecide.powl.semantics`, now or ever — not directly, not transitively,
...
------------------------------------------
:mod:`skdecide.powl.algebra` already refuses most of these conditions at
...
----------------------------------
A cycle in a :class:`~skdecide.powl.algebra.ChoiceGraph` is how POWL 2.0
expresses iteration and is **never** a refusal. Only a cycle in a
:class:`~skdecide.powl.algebra.PartialOrder` is.
...
def validate_model(node: PowlNode) -> None:
    ...
    :class:`~skdecide.powl.refusals.PowlError` carrying the specific
    :class:`~skdecide.powl.refusals.PowlRefusal` that was violated.
    """
