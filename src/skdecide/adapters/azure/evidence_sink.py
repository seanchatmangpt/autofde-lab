...
The distinction is the same one drawn in ``src/skdecide/CLAUDE.md`` about the
...
from skdecide.adapters.azure.base import AzureProbe, AzureSurface
from skdecide.adapters.azure.probe import probe_surface
