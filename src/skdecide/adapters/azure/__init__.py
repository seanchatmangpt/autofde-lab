...
``from skdecide.adapters.azure import AzureIncidentAdapter`` and the registered
...
from skdecide.adapters.azure.base import (
...
from skdecide.adapters.azure.evidence_sink import AzureEvidenceSink
from skdecide.adapters.azure.identity import AzureIdentity
from skdecide.adapters.azure.incident_ingress import AzureIncidentIngress
from skdecide.adapters.azure.logic_apps import AzureLogicApps
from skdecide.adapters.azure.models import (
    AuthorityRequest,
...
from skdecide.adapters.azure.notification_capture import AzureNotificationCapture
from skdecide.adapters.azure.refusals import Refusal, RefusalCode
from skdecide.adapters.azure.sentinel import AzureSentinel
