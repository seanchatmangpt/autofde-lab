...
a decision* — the same claim ceiling :class:`~skdecide.agent.replan.ReplanningMode`
...
* :attr:`FaultKind.TORN_FIRE` — derived from
  :meth:`~skdecide.agent.ledger.OccurrenceLedger.outstanding`; see
  :func:`observe_torn_fire`.
* :attr:`FaultKind.DUPLICATE_OBSERVATION` — derived from committed
  :class:`~skdecide.powl.identity.OccurrenceKey` membership; see
...
from skdecide.agent.refusals import AgentRefusalCode
