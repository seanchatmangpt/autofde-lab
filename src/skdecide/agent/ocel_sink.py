...
What this is
------------
A **one-way projection**: ledger lines in, :class:`~skdecide.ocel.log.OcelLog`
...
-----------------------------------------------
This module imports :mod:`skdecide.ocel`; :mod:`skdecide.ocel` must never
...
Definition 2, p. 6 -- see :meth:`~skdecide.ocel.log.OcelLog.validate` law 1).
...
from skdecide.agent.ledger import LedgerPhase, LedgerRecord, ObjectRef, OccurrenceLedger
from skdecide.ocel.log import OcelLog
from skdecide.ocel.model import OcelAttributeValue, OcelObject
...
class OcelSink:
    ...
    def validated(self, *, strict_qualifiers: bool = True) -> OcelLog:
        ...
        :meth:`~skdecide.ocel.log.OcelLog.validate` defaults it off: the ledger
