...
from skdecide.agent.ledger import IntentToken, OccurrenceLedger
from skdecide.agent.models import (
...
from skdecide.fabric.canonical import implementation_identity, sha256
...
from skdecide.powl.algebra import Atom, PowlNode
...
class AgentSession:
    ...
    def open_epoch(
        ...
        :func:`skdecide.agent.replan.seed_marking`, which is what makes
    ...
    def _decided_by(self) -> str:
        if self._solver is None:
            return "policy:skdecide.utils.rollout.RandomWalk"
    ...
    def step(
        ...
        a :class:`~skdecide.powl.algebra.ChoiceGraph`'s boundary nodes are
