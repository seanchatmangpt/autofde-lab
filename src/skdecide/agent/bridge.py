...
"""The only coupling between the agent runtime and :func:`skdecide.utils.rollout`.
...
from skdecide.powl.algebra import Atom
from skdecide.powl.executor import NodePath, node_at
from skdecide.utils import RolloutCallback
