...
Terraform resource graph — is what :mod:`skdecide.autofde.reconstruct` reads.
...
from skdecide.autofde.phase_graph import PhaseGraph, reduce_order, work_partial_order
...
def render_tfvars(graph: PhaseGraph) -> str:
    ...
    """
    parts: list[str] = [
        "# GENERATED by `python -m skdecide.autofde` from the admitted AutoFDE",
        "# phase graph (src/skdecide/autofde/phase_graph.py). Do not hand-edit.",
        "#",
...
def render_project_plan_json(graph: PhaseGraph) -> str:
    ...
    payload: dict[str, Any] = {
        "generator": "skdecide.autofde.github_projection",
        "applied": False,
        "milestones": [
            {
                "key": pid,
