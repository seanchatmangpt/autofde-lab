...
---------------------
This module **must not import** :mod:`skdecide.autofde.github_projection`.
...
:mod:`skdecide.powl.membership`, which is forbidden from importing
:mod:`skdecide.powl.executor` (see ``tests/powl/test_membership.py``).
...
from skdecide.powl import Atom, NodeId, OrderEdge, PartialOrder
