...
The **provisioning graph** (Terraform, see :mod:`skdecide.autofde.github_projection`)
...
:mod:`skdecide.autofde.github_projection`.
...
def reduce_order(po: PartialOrder) -> frozenset[OrderEdge]:
    ...
    :func:`skdecide.powl.transitive_reduction` explicitly so the round-trip law
