...
``Solver.check_domain`` (``src/skdecide/solvers.py:123``) applies, but sourced
...
accepts the flag and ignores it (``src/skdecide/utils.py:126`` carries
...
from skdecide.fabric.ontology import SKD, parse_turtle
...
def _characteristic_classes() -> Dict[str, type]:
    ...
    import skdecide.builders.domain as builders
