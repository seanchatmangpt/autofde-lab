...
:class:`~skdecide.hub.domain.pddl.PDDLDomain` and the registered ``Astar``
...
PROG = "skdecide-classical-engine"
...
def unsupported_requirements(domain_path: str, problem_path: str) -> List[str]:
    ...
    """
    from skdecide.hub.domain.pddl import PDDLReader
...
def solve_to_plan_file(
    ...
    if powl_path is not None:
        from skdecide.fabric.powl import DigestUnavailable, project_plan_to_powl
