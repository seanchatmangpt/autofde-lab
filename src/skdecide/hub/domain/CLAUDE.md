...
from `src/skdecide/builders/domain/` into one class, usually via a preset in
`src/skdecide/domains.py` (`RLDomain`, `MDPDomain`, `GoalMDPDomain`,
...
`src/skdecide/builders/domain/` (the mixins), `src/skdecide/domains.py` (presets),
