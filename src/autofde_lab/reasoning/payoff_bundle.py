...
def _observation_dict(observation: PayoffObservation) -> dict[str, Any]:
    ...
    return {
        ...
        "left_score": observation.left_score,
        "right_score": observation.right_score,
...
def encode_payoff_bundle(observations: Iterable[PayoffObservation]) -> str:
    ...
    return json.dumps(bundle, ensure_ascii=True, sort_keys=True, separators=(",", ":"))
...
def decode_payoff_bundle(payload: str) -> tuple[PayoffObservation, ...]:
    ...
    canonical = json.dumps(
        observations_raw, ensure_ascii=True, sort_keys=True, separators=(",", ":")
    )
