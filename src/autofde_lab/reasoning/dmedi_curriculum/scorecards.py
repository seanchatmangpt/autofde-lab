"""DMEDI curriculum module: MEASURE phase -- "Scorecards".
...
it is NOT yet implemented. It exists to admit "Scorecards" as a real,
...
calling plan_scorecards() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "MEASURE"
CURRICULUM_TOPIC = "Scorecards"


def plan_scorecards(*args, **kwargs):
    """Real, explicit refusal -- "Scorecards" (MEASURE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/scorecards.py"
    )
