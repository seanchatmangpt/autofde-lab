"""DMEDI curriculum module: DEVELOP phase -- "Lean Design".
...
it is NOT yet implemented. It exists to admit "Lean Design" as a real,
...
calling plan_lean_design() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEVELOP"
CURRICULUM_TOPIC = "Lean Design"


def plan_lean_design(*args, **kwargs):
    """Real, explicit refusal -- "Lean Design" (DEVELOP phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/lean_design.py"
    )
