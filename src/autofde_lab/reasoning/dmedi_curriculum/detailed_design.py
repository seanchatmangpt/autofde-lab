"""DMEDI curriculum module: DEVELOP phase -- "Detailed Design".
...
it is NOT yet implemented. It exists to admit "Detailed Design" as a real,
...
calling plan_detailed_design() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEVELOP"
CURRICULUM_TOPIC = "Detailed Design"


def plan_detailed_design(*args, **kwargs):
    """Real, explicit refusal -- "Detailed Design" (DEVELOP phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/detailed_design.py"
    )
