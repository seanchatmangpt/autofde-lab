"""DMEDI curriculum module: IMPLEMENT phase -- "Overview of the Implement Phase".
...
it is NOT yet implemented. It exists to admit "Overview of the Implement Phase" as a real,
...
calling plan_implement_phase_overview() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "IMPLEMENT"
CURRICULUM_TOPIC = "Overview of the Implement Phase"


def plan_implement_phase_overview(*args, **kwargs):
    """Real, explicit refusal -- "Overview of the Implement Phase" (IMPLEMENT phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/implement_phase_overview.py"
    )
