"""DMEDI curriculum module: IMPLEMENT phase -- "Prototype and Pilot".
...
it is NOT yet implemented. It exists to admit "Prototype and Pilot" as a real,
...
calling plan_prototype_and_pilot() raises NotImplementedError explicitly and loudly.
...
CURRICULUM_TOPIC = "Prototype and Pilot"


def plan_prototype_and_pilot(*args, **kwargs):
    """Real, explicit refusal -- "Prototype and Pilot" (IMPLEMENT phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/prototype_and_pilot.py"
    )
