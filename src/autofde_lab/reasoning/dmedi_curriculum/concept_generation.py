"""DMEDI curriculum module: EXPLORE phase -- "Concept Generation".
...
it is NOT yet implemented. It exists to admit "Concept Generation" as a real,
...
calling plan_concept_generation() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Concept Generation"


def plan_concept_generation(*args, **kwargs):
    """Real, explicit refusal -- "Concept Generation" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/concept_generation.py"
    )
