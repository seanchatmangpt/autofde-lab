"""DMEDI curriculum module: EXPLORE phase -- "Concept Selection - AHP".
...
it is NOT yet implemented. It exists to admit "Concept Selection - AHP" as a real,
...
calling plan_concept_selection_ahp() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Concept Selection - AHP"


def plan_concept_selection_ahp(*args, **kwargs):
    """Real, explicit refusal -- "Concept Selection - AHP" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/concept_selection_ahp.py"
    )
