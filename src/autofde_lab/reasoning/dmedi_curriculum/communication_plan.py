"""DMEDI curriculum module: DEFINE phase -- "Communication Plan".
...
it is NOT yet implemented. It exists to admit "Communication Plan" as a real,
...
calling plan_communication_plan() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEFINE"
CURRICULUM_TOPIC = "Communication Plan"


def plan_communication_plan(*args, **kwargs):
    """Real, explicit refusal -- "Communication Plan" (DEFINE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/communication_plan.py"
    )
