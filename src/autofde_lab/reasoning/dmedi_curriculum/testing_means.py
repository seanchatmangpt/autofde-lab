"""DMEDI curriculum module: EXPLORE phase -- "Testing Means".
...
it is NOT yet implemented. It exists to admit "Testing Means" as a real,
...
calling plan_testing_means() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Testing Means"


def plan_testing_means(*args, **kwargs):
    """Real, explicit refusal -- "Testing Means" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/testing_means.py"
    )
