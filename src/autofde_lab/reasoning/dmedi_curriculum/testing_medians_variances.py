"""DMEDI curriculum module: EXPLORE phase -- "Testing Medians and Variances".
...
it is NOT yet implemented. It exists to admit "Testing Medians and Variances" as a real,
...
calling plan_testing_medians_variances() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Testing Medians and Variances"


def plan_testing_medians_variances(*args, **kwargs):
    """Real, explicit refusal -- "Testing Medians and Variances" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/testing_medians_variances.py"
    )
