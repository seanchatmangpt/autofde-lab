"""DMEDI curriculum module: EXPLORE phase -- "Multiple Regression".
...
it is NOT yet implemented. It exists to admit "Multiple Regression" as a real,
...
calling plan_multiple_regression() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Multiple Regression"


def plan_multiple_regression(*args, **kwargs):
    """Real, explicit refusal -- "Multiple Regression" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/multiple_regression.py"
    )
