"""DMEDI curriculum module: DEVELOP phase -- "Conjoint Analysis".
...
it is NOT yet implemented. It exists to admit "Conjoint Analysis" as a real,
...
calling plan_conjoint_analysis() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEVELOP"
CURRICULUM_TOPIC = "Conjoint Analysis"


def plan_conjoint_analysis(*args, **kwargs):
    """Real, explicit refusal -- "Conjoint Analysis" (DEVELOP phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/conjoint_analysis.py"
    )
