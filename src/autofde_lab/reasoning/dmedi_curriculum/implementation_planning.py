"""DMEDI curriculum module: IMPLEMENT phase -- "Implementation Planning".
...
it is NOT yet implemented. It exists to admit "Implementation Planning" as a real,
...
calling plan_implementation_planning() raises NotImplementedError explicitly and loudly.
...
CURRICULUM_TOPIC = "Implementation Planning"


def plan_implementation_planning(*args, **kwargs):
    """Real, explicit refusal -- "Implementation Planning" (IMPLEMENT phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/implementation_planning.py"
    )
