"""DMEDI curriculum module: DEVELOP phase -- "Helicopter RSM Simulation".
...
it is NOT yet implemented. It exists to admit "Helicopter RSM Simulation" as a real,
...
calling plan_helicopter_rsm_simulation() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEVELOP"
CURRICULUM_TOPIC = "Helicopter RSM Simulation"


def plan_helicopter_rsm_simulation(*args, **kwargs):
    """Real, explicit refusal -- "Helicopter RSM Simulation" (DEVELOP phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/helicopter_rsm_simulation.py"
    )
