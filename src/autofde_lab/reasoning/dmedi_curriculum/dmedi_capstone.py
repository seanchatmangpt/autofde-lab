"""DMEDI curriculum module: IMPLEMENT phase -- "DMEDI Capstone".
...
it is NOT yet implemented. It exists to admit "DMEDI Capstone" as a real,
...
calling plan_dmedi_capstone() raises NotImplementedError explicitly and loudly.
...
CURRICULUM_TOPIC = "DMEDI Capstone"


def plan_dmedi_capstone(*args, **kwargs):
    """Real, explicit refusal -- "DMEDI Capstone" (IMPLEMENT phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/dmedi_capstone.py"
    )
