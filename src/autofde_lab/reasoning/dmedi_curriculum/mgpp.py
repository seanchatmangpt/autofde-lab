"""DMEDI curriculum module: DEFINE phase -- "MGPP".
...
it is NOT yet implemented. It exists to admit "MGPP" as a real,
...
calling plan_mgpp() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEFINE"
CURRICULUM_TOPIC = "MGPP"


def plan_mgpp(*args, **kwargs):
    """Real, explicit refusal -- "MGPP" (DEFINE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/mgpp.py"
    )
