"""DMEDI curriculum module: EXPLORE phase -- "Proportion Testing".
...
it is NOT yet implemented. It exists to admit "Proportion Testing" as a real,
...
calling plan_proportion_testing() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Proportion Testing"


def plan_proportion_testing(*args, **kwargs):
    """Real, explicit refusal -- "Proportion Testing" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/proportion_testing.py"
    )
