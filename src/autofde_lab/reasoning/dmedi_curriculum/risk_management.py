"""DMEDI curriculum module: DEFINE phase -- "Risk Management".
...
it is NOT yet implemented. It exists to admit "Risk Management" as a real,
...
calling plan_risk_management() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEFINE"
CURRICULUM_TOPIC = "Risk Management"


def plan_risk_management(*args, **kwargs):
    """Real, explicit refusal -- "Risk Management" (DEFINE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/risk_management.py"
    )
