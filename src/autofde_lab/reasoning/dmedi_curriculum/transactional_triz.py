"""DMEDI curriculum module: EXPLORE phase -- "Transactional TRIZ".
...
it is NOT yet implemented. It exists to admit "Transactional TRIZ" as a real,
...
calling plan_transactional_triz() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Transactional TRIZ"


def plan_transactional_triz(*args, **kwargs):
    """Real, explicit refusal -- "Transactional TRIZ" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/transactional_triz.py"
    )
