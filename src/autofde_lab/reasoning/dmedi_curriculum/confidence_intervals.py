"""DMEDI curriculum module: EXPLORE phase -- "Confidence Intervals".
...
it is NOT yet implemented. It exists to admit "Confidence Intervals" as a real,
...
calling plan_confidence_intervals() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Confidence Intervals"


def plan_confidence_intervals(*args, **kwargs):
    """Real, explicit refusal -- "Confidence Intervals" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/confidence_intervals.py"
    )
