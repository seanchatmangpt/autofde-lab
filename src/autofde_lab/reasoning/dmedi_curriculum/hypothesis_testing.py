"""DMEDI curriculum module: EXPLORE phase -- "Hypothesis Testing".
...
it is NOT yet implemented. It exists to admit "Hypothesis Testing" as a real,
...
calling plan_hypothesis_testing() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Hypothesis Testing"


def plan_hypothesis_testing(*args, **kwargs):
    """Real, explicit refusal -- "Hypothesis Testing" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/hypothesis_testing.py"
    )
