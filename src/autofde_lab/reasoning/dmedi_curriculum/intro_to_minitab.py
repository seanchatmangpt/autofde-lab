"""DMEDI curriculum module: MEASURE phase -- "Intro to Minitab".
...
it is NOT yet implemented. It exists to admit "Intro to Minitab" as a real,
...
calling plan_intro_to_minitab() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "MEASURE"
CURRICULUM_TOPIC = "Intro to Minitab"


def plan_intro_to_minitab(*args, **kwargs):
    """Real, explicit refusal -- "Intro to Minitab" (MEASURE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/intro_to_minitab.py"
    )
