"""DMEDI curriculum module: EXPLORE phase -- "Concept Selection - Pugh".
...
it is NOT yet implemented. It exists to admit "Concept Selection - Pugh" as a real,
...
calling plan_concept_selection_pugh() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Concept Selection - Pugh"


def plan_concept_selection_pugh(*args, **kwargs):
    """Real, explicit refusal -- "Concept Selection - Pugh" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/concept_selection_pugh.py"
    )
