"""DMEDI curriculum module: EXPLORE phase -- "Multi-Vari Analysis".
...
it is NOT yet implemented. It exists to admit "Multi-Vari Analysis" as a real,
...
calling plan_multi_vari_analysis() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Multi-Vari Analysis"


def plan_multi_vari_analysis(*args, **kwargs):
    """Real, explicit refusal -- "Multi-Vari Analysis" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/multi_vari_analysis.py"
    )
