"""DMEDI curriculum module: DEVELOP phase -- "DOE Catapult Simulation".
...
it is NOT yet implemented. It exists to admit "DOE Catapult Simulation" as a real,
...
calling plan_doe_catapult_simulation() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEVELOP"
CURRICULUM_TOPIC = "DOE Catapult Simulation"


def plan_doe_catapult_simulation(*args, **kwargs):
    """Real, explicit refusal -- "DOE Catapult Simulation" (DEVELOP phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/doe_catapult_simulation.py"
    )
