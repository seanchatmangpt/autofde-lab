"""DMEDI curriculum module: DEFINE phase -- "Charter".
...
it is NOT yet implemented. It exists to admit "Charter" as a real,
...
calling plan_charter() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEFINE"
CURRICULUM_TOPIC = "Charter"


def plan_charter(*args, **kwargs):
    """Real, explicit refusal -- "Charter" (DEFINE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/charter.py"
    )
