"""DMEDI curriculum module: EXPLORE phase -- "Simple Regression".
...
it is NOT yet implemented. It exists to admit "Simple Regression" as a real,
...
calling plan_simple_regression() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Simple Regression"


def plan_simple_regression(*args, **kwargs):
    """Real, explicit refusal -- "Simple Regression" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/simple_regression.py"
    )
