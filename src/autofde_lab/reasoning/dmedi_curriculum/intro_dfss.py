"""DMEDI curriculum module: DEFINE phase -- "Introduction to Design for Lean Six Sigma".
...
it is NOT yet implemented. It exists to admit "Introduction to Design for Lean Six Sigma" as a real,
...
calling plan_intro_dfss() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEFINE"
CURRICULUM_TOPIC = "Introduction to Design for Lean Six Sigma"


def plan_intro_dfss(*args, **kwargs):
    """Real, explicit refusal -- "Introduction to Design for Lean Six Sigma" (DEFINE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/intro_dfss.py"
    )
