"""DMEDI curriculum module: IMPLEMENT phase -- "Process Control".
...
it is NOT yet implemented. It exists to admit "Process Control" as a real,
...
calling plan_process_control() raises NotImplementedError explicitly and loudly.
...
CURRICULUM_TOPIC = "Process Control"


def plan_process_control(*args, **kwargs):
    """Real, explicit refusal -- "Process Control" (IMPLEMENT phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/process_control.py"
    )
