"""DMEDI curriculum module: MEASURE phase -- "Understanding Variation and Control Charts".
...
it is NOT yet implemented. It exists to admit "Understanding Variation and Control Charts" as a real,
...
calling plan_control_charts() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "MEASURE"
CURRICULUM_TOPIC = "Understanding Variation and Control Charts"


def plan_control_charts(*args, **kwargs):
    """Real, explicit refusal -- "Understanding Variation and Control Charts" (MEASURE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/control_charts.py"
    )
