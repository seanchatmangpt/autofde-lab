"""DMEDI curriculum module: EXPLORE phase -- "Monte Carlo Simulation".
...
it is NOT yet implemented. It exists to admit "Monte Carlo Simulation" as a real,
...
calling plan_monte_carlo_simulation() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Monte Carlo Simulation"


def plan_monte_carlo_simulation(*args, **kwargs):
    """Real, explicit refusal -- "Monte Carlo Simulation" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/monte_carlo_simulation.py"
    )
