"""DMEDI curriculum module: DEVELOP phase -- "Design of Experiments with Curvature".
...
it is NOT yet implemented. It exists to admit "Design of Experiments with Curvature" as a real,
...
calling plan_doe_with_curvature() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEVELOP"
CURRICULUM_TOPIC = "Design of Experiments with Curvature"


def plan_doe_with_curvature(*args, **kwargs):
    """Real, explicit refusal -- "Design of Experiments with Curvature" (DEVELOP phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/doe_with_curvature.py"
    )
