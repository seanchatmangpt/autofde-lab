"""DMEDI curriculum module: DEVELOP phase -- "Intro to Reliability".
...
it is NOT yet implemented. It exists to admit "Intro to Reliability" as a real,
...
calling plan_intro_to_reliability() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEVELOP"
CURRICULUM_TOPIC = "Intro to Reliability"


def plan_intro_to_reliability(*args, **kwargs):
    """Real, explicit refusal -- "Intro to Reliability" (DEVELOP phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/intro_to_reliability.py"
    )
