"""DMEDI curriculum module: EXPLORE phase -- "Design FMEA".
...
it is NOT yet implemented. It exists to admit "Design FMEA" as a real,
...
calling plan_design_fmea() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "EXPLORE"
CURRICULUM_TOPIC = "Design FMEA"


def plan_design_fmea(*args, **kwargs):
    """Real, explicit refusal -- "Design FMEA" (EXPLORE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/design_fmea.py"
    )
