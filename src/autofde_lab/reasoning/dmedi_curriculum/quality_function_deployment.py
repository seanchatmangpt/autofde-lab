"""DMEDI curriculum module: MEASURE phase -- "Quality Function Deployment".
...
it is NOT yet implemented. It exists to admit "Quality Function Deployment" as a real,
...
calling plan_quality_function_deployment() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "MEASURE"
CURRICULUM_TOPIC = "Quality Function Deployment"


def plan_quality_function_deployment(*args, **kwargs):
    """Real, explicit refusal -- "Quality Function Deployment" (MEASURE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/quality_function_deployment.py"
    )
