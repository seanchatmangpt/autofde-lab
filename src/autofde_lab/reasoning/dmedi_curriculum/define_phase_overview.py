"""DMEDI curriculum module: DEFINE phase -- "Overview of the Define Phase".
...
it is NOT yet implemented. It exists to admit "Overview of the Define Phase" as a real,
...
calling plan_define_phase_overview() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEFINE"
CURRICULUM_TOPIC = "Overview of the Define Phase"


def plan_define_phase_overview(*args, **kwargs):
    """Real, explicit refusal -- "Overview of the Define Phase" (DEFINE phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/define_phase_overview.py"
    )
