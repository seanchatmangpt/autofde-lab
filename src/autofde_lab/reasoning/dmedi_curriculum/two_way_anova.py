"""DMEDI curriculum module: DEVELOP phase -- "2-Way ANOVA".
...
it is NOT yet implemented. It exists to admit "2-Way ANOVA" as a real,
...
calling plan_two_way_anova() raises NotImplementedError explicitly and loudly.
...
DMEDI_PHASE = "DEVELOP"
CURRICULUM_TOPIC = "2-Way ANOVA"


def plan_two_way_anova(*args, **kwargs):
    """Real, explicit refusal -- "2-Way ANOVA" (DEVELOP phase) is not yet
    ...
    raise NotImplementedError(
        ...
        "src/autofde_lab/reasoning/dmedi_curriculum/two_way_anova.py"
    )
