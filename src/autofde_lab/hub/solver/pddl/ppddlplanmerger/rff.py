...
try:
    from autofde_lab.hub.__skdecide_hub_cpp import _RFFSolver_ as CppRFFSolver
    ...
    class RFF(Solver, DeterministicPolicies, Utilities, FromAnyState):
        ...
        effect-tree level, plans with FF from terminal states, and merges
        plans into a policy until Monte-Carlo assessment shows the
        replanning probability is below a threshold rho.
        ...
        def __init__(
            ...
            parallel: bool = False,
            callback: Callable[["RFF"], bool] = lambda slv: False,
            verbose: bool = False,
        ) -> None:
            """Construct an RFF solver instance.
