...
try:
    from autofde_lab.hub.__skdecide_hub_cpp import _AOStarSolver_ as aostar_solver
    ...
    class AOstar(
        ...
        """This is the autofde_lab implementation of the AO* algorithm for searching
