...
from autofde_lab.builders.solver import (
...
try:
    from autofde_lab.hub.__skdecide_hub_cpp import _MCTSOptions_ as mcts_options
    from autofde_lab.hub.__skdecide_hub_cpp import _MCTSSolver_ as mcts_solver
    ...
    class MCTS(ParallelSolver, Solver, DeterministicPolicies, Utilities, FromAnyState):
        """This is the autofde_lab implementation of MCTS and UCT from
        ...
        heuristic search algorithms in autofde_lab.
        """
