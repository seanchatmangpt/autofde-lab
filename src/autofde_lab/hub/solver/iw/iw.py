...
try:
    from autofde_lab.hub.__skdecide_hub_cpp import _IWSolver_ as iw_solver
    ...
    class IW(ParallelSolver, Solver, DeterministicPolicies, Utilities, FromAnyState):
        """This is the autofde_lab implementation of the Iterated Width algorithm as described
