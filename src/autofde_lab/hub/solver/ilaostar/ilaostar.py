...
try:
    from autofde_lab.hub.__skdecide_hub_cpp import _ILAOStarSolver_ as ilaostar_solver
    ...
    class ILAOstar(
        ...
        """This is the autofde_lab implementation of Improved-LAO* as described in
