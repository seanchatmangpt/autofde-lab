...
Produced by `src/autofde_lab/iec/`. Every file is deterministic (no timestamps, no local
...
- `c1/` — `python -m autofde_lab.iec.crown --checkout <ggen_igniter@d84da141>
  ...
  `promotion-plan.json`.
- `c3/` — `python -m autofde_lab.iec.c3 --autofde-lab . --c3-dir receipts/v26.9.23/iec/c3
